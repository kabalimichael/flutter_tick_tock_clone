...
import 'package:flutter_video_stream_tiktok_clone/ui/page/user_details_page.dart';
import 'package:flutter_video_stream_tiktok_clone/ui/screens/widgets/tool_top_row.dart';
        ...
        children: <Widget>[
          Tapped(
            child: _UserRightButton(
              title: widget.isSelfPage ? 'wallet' : 'attention',
            ),
          ),
        ],
      ),
    ...
    Widget avatar = Container(
      ...
      child: OverflowBox(
        ...
        child: Container(
          ...
          child: ClipOval(
            child: Image.network(
              "https://media.giphy.com/media/l2Je8kAWvC2ngLf2w/giphy.gif",
              fit: BoxFit.cover,
            ),
          ),
        ),
            ...
            children: <Widget>[
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    TextGroup('356', 'attention'),
                    TextGroup('145k', 'Fans'),
                    TextGroup('1423k', 'Praised'),
                  ],
                ),
              ),
              Container(
