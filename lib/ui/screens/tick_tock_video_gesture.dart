...
/// Click：Pause
/// 
// Double click: like, double click and then click again to increase like love
...
class _TikTokVideoGestureState extends State<TikTokVideoGesture> {
  ...
  // Internal conversion coordinate point
  Offset _p(Offset p) {
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      onTapDown: (detail) {
        setState(() {
          if (canAddFavorite) {
            print('Add hearts, current number of hearts:${icons.length}');
